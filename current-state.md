...
## Глобальные задачи (затрагивающие все)
...
* Агентам, работающим в одном процессе, доступны для перечисления ресурсы из всех сконфигурированных префиксов (системные префиксы, заданные пользователем префиксы, автодектированные префиксы).
* При помощи конфигурационных файлов возможно переопределение:
  ...
  * отдельных путей ресурсов на иные по маске типа glob или регулярному выражению.
...
gkd-pixbuf-handler | строит эскизы для файлов, поддерживаемых gkd-pixbuf
