...
------------------|----------------
[0.1](../releng-0.1) | *Приведение в надлежащий вид ссылок, копирайтов, лицензий и решение прочих организационных вопросов*
...
libsde-utils-x11 | вспомогательные функции для работы с X11 ([вероятно, будет удалено в 0.2](../unnecessary-libraries-0.2))
libsde-utils-gtk | вспомогательные функции для работы с Gtk ([вероятно, будет удалено в 0.2](../unnecessary-libraries-0.2))
libsde-utils-jansson | вспомогательные функции для работы с Jansson ([вероятно, будет удалено в 0.2](../unnecessary-libraries-0.2))
